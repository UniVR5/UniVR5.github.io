...
$("#primary-nav li:eq("+ ascensor.data("current-page") +")").addClass("selected");
ascensor.on("scrollStart", function(event, floor){
	$("#primary-nav li").removeClass("selected");
	$("#primary-nav li:eq("+floor.to+")").addClass("selected");
});
$(".prev").click(function() {
